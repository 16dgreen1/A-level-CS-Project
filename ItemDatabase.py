...
cursor.execute("INSERT INTO items VALUES ('smg', 15, 5, 15, 15, 1, 'True', 30, 300, 240)")
cursor.execute("INSERT INTO items VALUES ('chain gun', 10, 3, 10, 15, 1, 'True', 150, 900, 360)")
...
cursor.execute("INSERT INTO items VALUES ('shotgun', 30, 20, 30, 10, 6, 'False', 8, 88, 300)")
